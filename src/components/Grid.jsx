...
const Grid = () => {
    return (
        <section className="w-[100vw] h-[1200px] max-lg:h-auto px-20 max-sm:px-5 py-[100px] max-sm:py-[60px]">
            <div className="w-full h-full flex gap-[80px] max-md:gap-[50px] max-sm:gap-[30px] max-lg:flex-col">
                ...
                <div className="w-[50%] max-lg:w-full h-full flex flex-col gap-[50px] max-md:gap-[30px] ">
                    <div className='w-full h-[50%] max-md:h-[450px] max-lg:h-[600px] max-sm:h-[300px]'>
